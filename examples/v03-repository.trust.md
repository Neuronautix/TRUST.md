...
title: "Repository-level TRUST.md v0.3 example"
description: "The smallest useful repository-level assessment."
...
This example shows that adopters do not need artifact or claim records. A
repository-only declaration is fully conformant.
